...
export default function Sidebar(props) {
  ...
  return (
    <>
      {/* <div className="w-1/2 md:w-1/3 lg:w-64 fixed md:top-0 md:left-0 h-screen lg:block bg-gray-100 border-r z-30" :className="sideBarOpen ? '' : 'hidden'" id="main-nav"> */}
      ...
      >
        <div
          style={{ height: "auto" }}
          className="w-full border-b flex px-4 items-center mb-8"
        >
          <p className="font-medium text-xl text-blue-400 pl-4 py-3">
            BINTREST TRADE
          </p>
        </div>

        <div className="mb-4 px-4">
          <p className="pl-4 text-sm font-semibold text-lg mb-1">MAIN</p>
          <a
            href="/dashboard"
            className={`w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer mb-2 ${
          ...
          >
            ...
            <span className="text-gray-700 text-lg font-medium">Overview</span>
          </a>
          <a
    ...
    <span className="text-gray-700 text-lg font-medium">Analytics</span>
  </div> */}
          {/* <div className="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
    <svg className="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
    ...
    <span className="text-gray-700 text-lg font-medium">Inventory</span>
  </div>
  <div className="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
    <svg className="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
    ...
    <span className="text-gray-700 text-lg font-medium">Enquiries</span>
  </div>
  <div className="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
    <svg className="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
    ...
    <span className="text-gray-700 text-lg font-medium">Calender</span>
  </div> */}
        </div>

        <div className="mb-4 px-4">
          <p className="pl-4 text-sm font-semibold text-lg mb-1">ACTIONS</p>
          <a
          ...
          >
            ...
            <span className="text-gray-700 text-lg font-medium">Deposit</span>
          </a>
          <a
          ...
          >
            ...
            <span className="text-gray-700 text-lg font-medium">Withdraw</span>
          </a>
    ...
    <span className="text-gray-700 text-lg font-medium">Logout</span>
          ...
          <a
            href="/user/logout"
            className="bg-blue-500 hover:bg-blue-600 focus:outline-none rounded-lg my-2 px-6 py-2 text-white font-semibold shadow w-full flex flex-col h-10 pl-4 cursor-pointer text-center"
          >
            <p className="items-center">Log out</p>
          </a>
          {/* </div> */}
        </div>

        <div className={`mb-4 px-4 ${role == "admin" ? "" : "hidden"}`}>
          ...
          >
            <span className="text-gray-700 text-lg font-medium">Users</span>
          </a>

          <a
            href="/dashboard/manipulate-user"
            className={`w-full flex items-center text-blue-400 h-10 pl-4 ${
              props.pathname.href in paths ? "bg-gray-200" : "hover:bg-gray-200"
            } rounded-lg cursor-pointer`}
          >
          ...
          <a
            href="/dashboard/send-notifications"
            className={`w-full flex items-center text-blue-400 h-10 pl-4 ${
              props.pathname.href in paths ? "bg-gray-200" : "hover:bg-gray-200"
            } rounded-lg cursor-pointer`}
          >
  ...
  <div className="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
    ...
    <span className="text-gray-700 text-lg font-medium">Notices</span>
  </div>
  <div className="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
    <svg className="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
    ...
    <span className="text-gray-700 text-lg font-medium">Controls</span>
  </div>
  <div className="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
    <svg className="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
    ...
    <span className="text-gray-700 text-lg font-medium">Settings</span>
  </div>
</div> */}
      </div>
    </>
